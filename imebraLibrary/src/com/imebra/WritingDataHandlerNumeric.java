...
public class WritingDataHandlerNumeric extends WritingDataHandler {
  ...
  public WritingDataHandlerNumeric(WritingDataHandlerNumeric source) {
    this(imebraJNI.new_WritingDataHandlerNumeric(WritingDataHandlerNumeric.getCPtr(source), source), true);
  }

  public MutableMemory getMemory() {
    return new MutableMemory(imebraJNI.WritingDataHandlerNumeric_getMemory(swigCPtr, this), true);
  }
